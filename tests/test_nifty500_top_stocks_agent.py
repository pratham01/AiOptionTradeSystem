...
async def test_get_top_stocks_analysis_success(mock_dt, MockAgent, mock_create_broker, mock_gainer_rows, mock_fo_worst_rows):
...
@patch("trade_system.application.agent.nifty500_top_stocks_agent.BrokerTopGainersAgent")
@patch("trade_system.application.agent.nifty500_top_stocks_agent.datetime")
async def test_get_top_stocks_analysis_no_llm(mock_dt, MockAgent, mock_create_broker, mock_gainer_rows, mock_fo_worst_rows):
