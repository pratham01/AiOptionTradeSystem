...
from trade_system.application.strategies.sma_cross import SmaCrossStrategy
...
from trade_system.application.strategies.volume_profile import VolumeProfileStrategy
