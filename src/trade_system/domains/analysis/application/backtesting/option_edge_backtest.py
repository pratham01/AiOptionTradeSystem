...
from trade_system.domains.analysis.application.analysis.regime_detector import RegimeDetector, MarketRegime
...
from trade_system.domains.analysis.application.analysis.option_strike_selector import OptionStrikeSelector
...
class OptionEdgeBacktest:
    ...
    def _build_summary(self, trades_df: pd.DataFrame) -> pd.DataFrame:
        ...
        trades_df["trade_date"] = pd.to_datetime(trades_df["trade_date"], format="mixed")
