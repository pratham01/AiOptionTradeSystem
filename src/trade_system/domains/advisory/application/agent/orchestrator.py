...
from trade_system.domains.advisory.application.agent.nifty_option_buyer_agent import NiftyOptionBuyerAgent
...
from trade_system.shared.notifications.formatters import format_session_plan_telegram
...
class TradeOrchestrator:
    ...
    def _load_priority_watchlist(self) -> list | None:
        ...
        try:
            ...
            from trade_system.domains.advisory.application.agent.next_day_predictor_agent import WatchlistItem
